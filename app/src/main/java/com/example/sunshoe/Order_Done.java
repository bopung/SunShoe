...
public class Order_Done extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestQueue queue = Volley.newRequestQueue(Order_Done.this);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < data.length(); i++) {
                                ...
                                if (a.getString("status").equals("0")){
                                    trans.add(
                                            new ordertrans(
                                                    a.getInt("id"),
                            ...
                            transaction adapter = new transaction(Order_Done.this, trans);
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Order_Done.this, LinearLayoutManager.VERTICAL, false);
...
//                Toast.makeText(context, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
                    Toast.makeText(Order_Done.this, "Error, please check your connection", Toast.LENGTH_SHORT).show();

                }catch (Exception e){
                    Toast.makeText(Order_Done.this, "Unknown Error: " + error, Toast.LENGTH_LONG).show();
                }
